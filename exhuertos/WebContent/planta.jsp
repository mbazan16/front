...
<body class="planta">
	<form method="get" action="./huerto" id="formHuerto">
		 <input	hidden="true" type="text" name="accion" value="VER" /> <input
		...
		<div class="card">
			<div style="display: inline-block;">
				...
				<a href="#"
					...
					src="img/macetas.jpg" alt="${elemento.maceta.tipoMaceta.descripcion}" width="100"
					height="100">
				</a>
			</div>
	...
	<div id="panelModificarForm" style="display: none" class="card">
		<div style="display: inline-block;">
			<a href="./huerto?id=${elemento.maceta.huerto.id}"> <img
				src="img/huerto.jpg" alt="${elemento.maceta.huerto.nombre}"
				width="100" height="100">
